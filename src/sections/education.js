        ...
        <div className="px-8 sm:pr-16 sm:pl-0 mt-12">
          <div className="education-grid">
            <div className = "flex justify-center md:block">
              <img className="rounded-xl w-2/3 md:w-auto" src="../images/stanford-green.jpg" alt="Stanford Background" />
            </div>
          ...
          <div className="education-grid">
            <div className = "flex justify-center md:block">
              <img className="rounded-xl w-2/3 md:w-auto" src="../images/saratoga-green.jpg" alt="Stanford Background" />
            </div>
