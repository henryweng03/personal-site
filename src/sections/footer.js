  ...
  return (
    <div className="h-auto flex flex-col items-center sm:grid grid-cols-2">
      ...
      <div className = "flex justify-end items-center space-x-4">
        <a className="pb-5 sm:py-6" href="mailto:hweng@stanford.edu">
          <p className = "footer-link font-bold">
            Email
          </p>
        </a>
        <a className="pb-5 sm:py-6" href="https://www.linkedin.com/in/henry-weng/">
          <p className = "footer-link font-bold">
            LinkedIn
          </p>
        </a>
        <a className="pb-5 sm:py-6" href="https://github.com/henryweng03">
